						...
						<div class="table-responsive">
							<table class="table table-hover table-condensed table-striped">
								<thead class="thead thead-light">
									<tr>
										<th class="text-nowrap">Slide No.</th>
								...
								<tbody>
									...
									<tr>
										...
										<td><img width='50in' class='img-responsive' src="<?php echo WEBSITE_URL; ?>./images/slider/<?php echo $row['slider_img']; ?>"></td>
									...
									<?php }
											...
											echo "<tr><td colspan='8'><p>No record found for <b>{$search}</b></p></td></tr>";
										} 
									?>
								</tbody>
									...
									<td colspan="8">
										<?php
											if (isset($search)) {	
												...
												$total_slides = GetTotal($conn, TBLSLIDER);
												echo "Showing total <b>".$total_slides."</b> of <b>".$total_slides."</b> ";
												if ($total_slides > 1) {
													echo "results.";
												}else{ echo "result.";}
											}	
